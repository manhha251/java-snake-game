...
public class Register extends JPanel {
	...
	public Register() {
		...
		*/
		JLabel lbTitileGame = component.createLabelgameTitile();
		contentPane.add(lbTitileGame);
		...
		*/
		JButton btn_register = component.createButton("Register",135, 174, 103, 39, 18);
		pn_register.add(btn_register);
		...
		*/
		JLabel lb_player_name = component.createInformationlabel("Player Name: ",10, 128, 75, 17, 13);
		pn_register.add(lb_player_name);
