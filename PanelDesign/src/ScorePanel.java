...
public class ScorePanel extends JPanel {
	...
	private int score, high_score, apples, mode;
	...
	public ScorePanel(String name, int high_score, int score, int apples, int mode) {
	...
	private void initLayout() {
		...
		setPreferredSize(new Dimension(25*15, 25*20));
	...
	private void initUI() {
		...
		*/
		...
		lb_player_name.setForeground(score_label_color);
		lb_player_name.setFont(NORMAL_FONT);
		lb_player_name.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		*/
		...
		lb_high_score.setForeground(score_label_color);
		lb_high_score.setFont(NORMAL_FONT);
		lb_high_score.setHorizontalAlignment(SwingConstants.RIGHT);
		gbc.anchor = GridBagConstraints.WEST;
		gbc.insets = new Insets(0, 0, 5, 0);
		...
		*/
		...
		lb_score.setForeground(score_label_color);
		lb_score.setFont(NORMAL_FONT);
		lb_score.setHorizontalAlignment(SwingConstants.RIGHT);
		gbc.anchor = GridBagConstraints.WEST;
		gbc.insets = new Insets(0, 0, 5, 0);
		...
		*/
		...
		lb_apples.setForeground(score_label_color);
		lb_apples.setFont(NORMAL_FONT);
		lb_apples.setHorizontalAlignment(SwingConstants.RIGHT);
		gbc.anchor = GridBagConstraints.WEST;
		gbc.insets = new Insets(0, 0, 5, 0);
		...
		*/
		...
		lb_mode.setForeground(score_label_color);
		lb_mode.setFont(NORMAL_FONT);
		lb_mode.setHorizontalAlignment(SwingConstants.RIGHT);
		gbc.anchor = GridBagConstraints.WEST;
		gbc.insets = new Insets(0, 0, 5, 0);
	...
	public void setPlayerName(String name) {
		...
		lb_player_name.setText(player_name);
	}
	...
	public void updateMode() {
		...
		lb_mode.setText(Integer.toString(mode));
	}
